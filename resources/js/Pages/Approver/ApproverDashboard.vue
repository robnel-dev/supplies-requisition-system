...
<template>
    <div class="space-y-6">
        <PageHeader title="Approver Dashboard"
            description="Overview of approval activities, pending queue, and current metrics." />
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm ring-1 ring-gray-900/5">
            <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px] gap-6 lg:items-center">
                <div>
